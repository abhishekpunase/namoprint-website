...
export function TrophyProductCard({ product }) {
  ...
  const detailPath = `/trophies/${product.slug}`

  return (
    <article className="group relative flex h-full flex-col overflow-hidden rounded-xl border border-gray-200 bg-white transition hover:border-amber-400 hover:shadow-md sm:rounded-2xl sm:border-amber-100 sm:shadow-md sm:hover:-translate-y-1 sm:hover:shadow-xl">
      <div className="absolute inset-x-0 top-0 z-10 hidden h-1 bg-gradient-to-r from-amber-500 via-yellow-400 to-orange-400 sm:block" />

      <Link to={detailPath} className="relative block shrink-0 overflow-hidden bg-white sm:bg-amber-50">
        ...
        {mainSrc ? (
          ...
          <div className="flex aspect-square w-full items-center justify-center bg-amber-50 text-sm text-neutral-500 sm:aspect-[4/3]">
            No image
          </div>
        )}
      </Link>
      ...
      <div className="hidden flex-1 flex-col gap-3 p-4 sm:flex">
        <div className="flex items-center justify-between gap-2">
          <span className="truncate rounded-full bg-amber-100 px-3 py-0.5 text-[11px] font-semibold uppercase tracking-wide text-amber-900">
            Trophy &amp; Memento
          </span>
          <div className="flex shrink-0 items-center gap-1 rounded-full bg-orange-50 px-2 py-0.5">
            ...
            <span className="text-xs font-semibold text-gray-700">{product.ratingScore || 4.8}</span>
          </div>
        </div>
        ...
        <div className="mt-auto flex items-end justify-between gap-3">
          ...
          <Link
            to={detailPath}
            className="group/button inline-flex shrink-0 items-center gap-1.5 rounded-xl bg-gradient-to-r from-orange-500 via-orange-400 to-yellow-400 px-4 py-2 text-sm font-semibold text-white shadow-md transition hover:scale-[1.02]"
          >
            Customize
