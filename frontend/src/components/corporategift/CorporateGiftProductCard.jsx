...
export function CorporateGiftProductCard({ product }) {
  ...
  const detailPath = `/corporate-gifts/${product.slug}`
    ...
    <article className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-orange-100 bg-white shadow-md transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
      ...
      <div className="flex flex-1 flex-col gap-3 p-4">
        <div className="flex items-center justify-between gap-2">
          <span className="truncate rounded-full bg-slate-800 px-3 py-0.5 text-[11px] font-semibold uppercase tracking-wide text-white">
            Corporate Gift
          </span>
